        ...
        <div class="row w-100">
          <div class="col-lg-6 align-self-center">
            <p class="moto-text_system_2 mb-0">
              <span class="d-flex justify-content-center align-items-center"><i class="fa-solid fa-phone fa-sm"></i></span>&nbsp;&nbsp;<a href="tel:1234567890">+3(800)
                      ...
                      <ul class="menu-list menu-list_horizontal header m-0">
                        ...
                        <li class="moto-widget-menu-item menu-item-has-submenu">
                          ...
                          <ul class="menu-sublist">
                            ...
                            <li class="moto-widget-menu-item">
                              <a href="collections.php" data-action="store.category" class="menu-link menu-link-level-2 moto-link">EXCLUSIVE
                                COLLECTION</a>
                            </li>
                          </ul>
                        </li>
          ...
          <div class="col-sm-12" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top" bis_skin_checked="1">
            ...
            <div data-widget-id="wid_1524128091_05kg60ys0" class="" data-preset="default" data-widget="menu" bis_skin_checked="1">
              ...
              <ul class="menu-list menu-list_horizontal footer">
                <li class="moto-widget-menu-item">
                  <a href="index.php" data-action="home_page" class="menu-link menu-link-level-1 menu-link-active moto-link" bis_skin_checked="1">HOME</a>
                </li>
                <li class="moto-widget-menu-item">
