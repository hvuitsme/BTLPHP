    ...
    <div class="row mt-5">
      ...
      <div class="col-sm-3">
        <div class="row">
          ...
          <a href="accessories.php"><span style="color:red">PHỤ KIỆN</span></a>
      ...
      <div class="col-sm-9">
        ...
        <div class="container pt_2">
          <div class="row">
            ...
            $sql = "SELECT t1.`name_sp`, t1.`image_sp`, t1.`price`, t1.`code_sp` FROM `tb_image` t1 JOIN (SELECT `code_sp`, MAX(`id_sp`) AS max_id_sp FROM `tb_image` GROUP BY `code_sp`) t2 ON t1.`code_sp` = t2.`code_sp` AND t1.`id_sp` = t2.`max_id_sp` WHERE t1.`code_sp` LIKE '%PK%';";
