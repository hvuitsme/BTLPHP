...
<body>
    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-sm-7">
                ...
                {
                    $sql = "SELECT * FROM tb_product WHERE code_sp = '$code_sp'";
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                $sql = "SELECT `image_sp`, `name_sp`, `code_sp`, `price` FROM `tb_product` WHERE `code_sp` LIKE '%BM%' OR `code_sp` LIKE '%DC%' ORDER BY RAND() LIMIT 4;";
                $result = $conn->query($sql);
    ...
    <footer id="section-footer" class="footer moto-section moto-sticky__bootstrapped pt-5">
        <?php
