...
<body>
    ...
    //                         timer: 2000
    //                     }).then(function() {
    //                         // window.location.href = "/xampp/php/BAITAP/BTLPHP/Customer/home/index.php"; // Đường dẫn đầy đủ của hoàn
            ...
            if ($loginPassword === $row["password"]) {
                ...
                echo '<script type="text/javascript">
                        Swal.fire({
                            ...
                            window.location.href = "/xampp/php/BAITAP/BTLPHP/Customer/home/index.php"; // Đường dẫn đầy đủ của hoàn
                            //window.location.href = ""; // Đường dẫn đầy đủ của quỳnh
                        });
                    </script>';
                exit();
            } else {
                ...
                echo '<script type="text/javascript">
                        Swal.fire({
                            ...
                            window.location.href = "/xampp/php/BAITAP/BTLPHP/Customer/home/first.php"; // Đường dẫn đầy đủ của hoàn
                            //window.location.href = "http://localhost:3000/Customer/first.php"; // Đường dẫn đầy đủ của quỳnh
                        });
                    </script>';
            }
        } else {
