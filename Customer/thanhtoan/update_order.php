...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_order = $conn->prepare("INSERT INTO dathang (code_sp, user, ho_ten, gioi_tinh, sdt, Thanh_pho, dia_chi, payment_method, Tong_tien, Trang_thai, message) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    $stmt_order->bind_param("sssssssssss", $productCodesString,$username , $name, $gender, $phone_number, $country, $address, $payment_method, $totalAmount, $trang_thai, $message);
