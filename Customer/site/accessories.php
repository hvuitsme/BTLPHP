      ...
      <div class="col-sm-9">
        ...
        <div class="container pt_2">
          <div class="row">
            ...
            $sql = "SELECT t1.`name_sp`, t1.`image_sp`, t1.`price`, t1.`code_sp` FROM `tb_product` t1 JOIN ( SELECT `code_sp`, MAX(`Ma_sp`) AS max_Ma_sp FROM `tb_product` GROUP BY `code_sp` ) t2 ON t1.`code_sp` = t2.`code_sp` AND t1.`Ma_sp` = t2.`max_Ma_sp` WHERE t1.`code_sp` LIKE '%PK%';";
